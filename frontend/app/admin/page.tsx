...
const statuses: { value: AnnouncementStatus | ""; label: string }[] = [{ value: "", label: "Todos" }, { value: "published", label: "Publicados" }, { value: "closed", label: "Encerrados" }];
